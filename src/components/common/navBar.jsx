...
const NavBar = ({ active }) => {
	...
	const navLinkClass = (linkName) => {
		...
		return active === linkName
			? `${baseClass} text-slate-200 bg-emerald-600 md:bg-transparent md:text-emerald-700 md:dark:text-emerald-500 md:dark:bg-transparent dark:bg-slate-700 dark:text-slate-300 md:dark:hover:bg-slate-700 md:dark:hover:text-slate-300 md:dark:hover:text-emerald-500 md:dark:hover:bg-transparent`
			: baseClass;
	};
